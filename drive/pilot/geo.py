"""Geographic helpers for the edge runtime.

A third copy, and deliberately so. The world model has one, the simulated
vehicle has one, and PILOT has this one, because all three are separate
deployables and a machine in the field never imports server code. The claim
that the server cannot tell one machine from another only means something
if they do not share the arithmetic that produces their positions.
"""
